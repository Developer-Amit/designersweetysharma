      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li style="<?php echo $showstore;?>"><a href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?></a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group" style="<?php echo $showstore;?>">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <?php if(isset($storeid) && $storeid>0){ ?>
                    <div class="checkbox">
                      <label>
                        <?php if ($store['store_id']==$storeid) { ?>
                ...
                <table class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
					  ...
					  <td class="text-left"><?php echo $entry_rollover_image; ?></td><!--Added by nilkanthinfo-->
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    <tr>
					  ...
					  <!--Added by nilkanthinfo-->
					   <td class="text-left"><a href="" id="thumb-rollover-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $rollover_thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="rollover_image" value="<?php echo $rollover_image; ?>" id="input-rollover-image" /></td>
					   <!--Added by nilkanthinfo-->
            ...
            <div class="tab-pane" id="tab-design" style="<?php echo $showstore;?>">
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  <thead>
                    <tr>
