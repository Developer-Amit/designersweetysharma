            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'comment') { ?>
                    ...
                    <?php } ?></td>
				  <td class="text-left"><?php if ($sort =='blog_name') { ?>
                    <a href="<?php echo $sort_blog_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_blog_name; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_blog_name; ?>"><?php echo $column_blog_name; ?></a>
                    <?php } ?></td>
				  <td class="text-left"><?php if ($sort =='email_id') { ?>
                    <a href="<?php echo $sort_email_id; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_email_id; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_email_id; ?>"><?php echo $column_email_id; ?></a>
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'sort_created') { ?>
                    <a href="<?php echo $sort_created; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_created; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_created; ?>"><?php echo $column_created; ?></a>
                    <?php } ?></td>
				  <td class="text-right"><?php if ($sort == 'sort_status') { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $comment['blog_name']; ?></td>
				  <td class="text-left"><?php echo $comment['email_id']; ?></td>
                  <td class="text-right"><?php echo $comment['created']; ?></td>
