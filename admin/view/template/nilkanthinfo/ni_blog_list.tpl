              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
				  <td class="text-left"><?php if ($sort =='published_date') { ?>
                    <a href="<?php echo $sort_published_date; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_published_date; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_published_date; ?>"><?php echo $column_published_date; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($blog['blog_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $blog['blog_name']; ?></td>
                  <td class="text-right"><?php echo $blog['published_date']; ?></td>
				   <td class="text-right"><?php echo $blog['viewed']; ?></td>
