      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <select name="storeid" id="input-status" class="form-control">
                <option value="0" selected="selected"><?php echo $text_selectstore;?></option>
                <?php foreach($stores_data as $storedata){ ?>
                <?php if($store == $storedata['store_id']){?>
                  <option selected='selected' value="<?php echo $storedata['store_id'];?>"><?php echo $storedata['name'];?></option>
                <?php }else{?>
                  <option value="<?php echo $storedata['store_id'];?>"><?php echo $storedata['name'];?></option>
                <?php }} ?>
              </select>
              <?php if ($error_store) { ?>
