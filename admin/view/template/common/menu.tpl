<?php $showstore=""; if(isset($storeid) && $storeid>0){$showstore="display:none";}?>
<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li style="<?php echo $showstore;?>"><a href="<?php echo $recurring; ?>"><?php echo $text_recurring; ?></a></li>
      ...
      <li style="<?php echo $showstore;?>"><a href="<?php echo $option; ?>"><?php echo $text_option; ?></a></li>
      <li style="<?php echo $showstore;?>"><a href="<?php echo $manufacturer; ?>"><?php echo $text_manufacturer; ?></a></li>
      <li><a href="<?php echo $download; ?>"><?php echo $text_download; ?></a></li>
      <li><a href="<?php echo $review; ?>"><?php echo $text_review; ?></a></li>
      <li><a href="<?php echo $information; ?>"><?php echo $text_information; ?></a></li>
    </ul>
  </li>
  <li id="extension" style="<?php echo $showstore;?>"><a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i> <span><?php echo $text_extension; ?></span></a>
    <ul>
  ...
  <li id="design"><a class="parent"><i class="fa fa-television fa-fw"></i> <span><?php echo $text_design; ?></span></a>
    <ul>
      <li style="<?php echo $showstore;?>"><a href="<?php echo $layout; ?>"><?php echo $text_layout; ?></a></li>
  ...
  <li id="sale"><a class="parent"><i class="fa fa-shopping-cart fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
    <ul>
      ...
      <li style="<?php echo $showstore;?>"><a class="parent"><?php echo $text_paypal ?></a>
        <ul>
  ...
  <li id="customer" style="<?php echo $showstore;?>"><a class="parent"><i class="fa fa-user fa-fw"></i> <span><?php echo $text_customer; ?></span></a>
    <ul>
  ...
  <li style="<?php echo $showstore;?>"><a class="parent"><i class="fa fa-share-alt fa-fw"></i> <span><?php echo $text_marketing; ?></span></a>
    <ul>
  ...
  <li id="system" style="<?php echo $showstore;?>"><a class="parent"><i class="fa fa-cog fa-fw"></i> <span><?php echo $text_system; ?></span></a>
    <ul>
  ...
  <!--Option for nilkanthinfo_BLOG--> 
  <li id="nilkanthinfo"><a class="parent"><i class="fa fa-tumblr fa-fw"></i> <span><?php echo $text_ni; ?></span></a>
    <ul>
    <?php if($ni_blog!="") { ?>
    <li><a href="<?php echo $ni_blog; ?>"><?php echo $text_ni_blog; ?></a></li>
    <li><a href="<?php echo $ni_blog_comment; ?>"><?php echo $text_ni_blog_comment; ?></a></li>
    <?php } ?>
    <?php if($nilkanthinfo_newsletter!=""){ ?>
      <li><a href="<?php echo $nilkanthinfo_newsletter; ?>"><?php echo $text_nilkanthinfo_newsletter; ?></a></li>   <!--Option for nilkanthinfo_newsletter-->
       <?php } ?>
       <?php if($nilkanthinfo_testimonial!=""){ ?>
    <li><a href="<?php echo $nilkanthinfo_testimonial; ?>"><?php echo $text_nilkanthinfo_testimonial; ?></a></li>   <!--Option for nilkanthinfo_testimonial-->  
       <?php } ?>
     
    
     <li id="NI_default"><a href="<?php echo $NI_default; ?>"><?php echo $text_nilkanthinfo_default; ?></a></li> <!--Added by Nilkanthinfo-->
  </ul>
  </li>
   <!--Option for nilkanthinfo_BLOG-->
</ul>
