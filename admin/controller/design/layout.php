...
class ControllerDesignLayout extends Controller {
	...
	protected function getForm() {
		...
		//Added by nilkanthfo for extra layout position
		...
		$data['text_content_footer2'] = $this->language->get('text_content_footer2');
		$data['text_content_footer3'] = $this->language->get('text_content_footer3');
