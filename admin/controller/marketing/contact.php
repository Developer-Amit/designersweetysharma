...
class ControllerMarketingContact extends Controller {
	...
	public function index() {
		...
		//NI Newsletter subscribers list
		
		$module_name = 'nilkanthinfo_newsletter';
		$this->load->model('extension/extension');
			$installed_modules = $this->model_extension_extension->getInstalled('module');
			if(in_array($module_name, $installed_modules)) {
			  // Module installed
			  $data['text_NI_newsletter'] = $this->language->get('text_NI_newsletter');
			}
			else
			{
				$data['text_NI_newsletter'] = '';
			}
	...
	public function send() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			if (!$json) {
				...
				$this->load->model('nilkanthinfo/nilkanthinfo_newsletter');			//Added by Nilkanthinfo for NI newletter subscriber
				...
				switch ($this->request->post['to']) {
					...
					case 'NI_newsletter':
						...
						$email_total = $this->model_nilkanthinfo_nilkanthinfo_newsletter->getTotalNewsletters();

						$results = $this->model_nilkanthinfo_nilkanthinfo_newsletter->getNewsletters($customer_data);
