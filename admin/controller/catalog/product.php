...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_rollover_image'] = $this->language->get('entry_rollover_image');		//Added by nilkanthinfo
		...
		if(isset($this->session->data['storeid'])){
			$data['storeid'] = $this->session->data['storeid'];
		}else{
			$data['storeid'] = 0;
		}
		...
		if (isset($this->request->post['rollover_image'])) {
			$data['rollover_image'] = $this->request->post['rollover_image'];
		} elseif (!empty($product_info)) {
			$data['rollover_image'] = $product_info['rollover_image'];
		} else {
			$data['rollover_image'] = '';
		}
		...
		//Added by nilkanthinfo 
		if (isset($this->request->post['rollover_image']) && is_file(DIR_IMAGE . $this->request->post['rollover_image'])) {
			$data['rollover_thumb'] = $this->model_tool_image->resize($this->request->post['rollover_image'], 100, 100);
		} elseif (!empty($product_info) && is_file(DIR_IMAGE . $product_info['rollover_image'])) {
			$data['rollover_thumb'] = $this->model_tool_image->resize($product_info['rollover_image'], 100, 100);
		} else {
			$data['rollover_thumb'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
		//end Added by nilkanthinfo
