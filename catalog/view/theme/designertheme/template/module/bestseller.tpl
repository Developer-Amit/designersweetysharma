<div class="block bestseller_block">
<div class="container">
<h3 class="bestseller_block_heading block_heading"><span><?php echo $heading_title; ?></span></h3>
<?php	$slidelimit="4";	?>		<!-- Number of product limit for the slider by Nilkanthinfo.-->
<div class="block-product <?php if((sizeof($products) > $slidelimit) ) { if($position == 'column_left' || $position == 'column_right'){ echo 'slider-block-cat';} else { echo 'slider-block';}} else { echo 'grid-block';}  ?>">  <!-- Add class for owl carousal by  Nilkanthinfo-->
