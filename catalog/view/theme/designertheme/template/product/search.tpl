<?php echo $header; ?>
<div class="container">
<h2 class="cat_page_heading"><?php echo $heading_title; ?></h2>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
     ...
     <!-- <p><a href="<?php echo $compare; ?>" id="compare-total"><?php echo $text_compare; ?></a></p>-->
      <div class="row  filter-category">
        <div class="col-sm-3 hidden-xs grid-list-btn">
          <div class="btn-group">
       ...
       <div class="filter-right">
		 	<div class="sort-by-block">
				<div class="col-sm-1 col-sm-offset-2 text-right sort-by">
          <label class="control-label" for="input-sort"><?php echo $text_sort; ?></label>
        </div>
        <div class="col-sm-3 text-right sort">
          <select id="input-sort" class="form-control col-sm-3" onchange="location = this.value;">
            ...
            <?php } ?>
				...
				<div class="show-block">
					       <div class="col-sm-1 text-right show">
          <label class="control-label" for="input-limit"><?php echo $text_limit; ?></label>
        </div>
        <div class="col-sm-2 text-right limit">
