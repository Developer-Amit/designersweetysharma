...
$(document).ready(function() {
	...
	function mobile(){
      ...
      var parallax = document.querySelectorAll(".paralex-block"),
         speed = 0.3;
	...
	var bread='<div class="cat_banner-comman paralex-block1"><div class="container"><div class="row  category_thumb_block"><div class="col-sm-12"><ul class="breadcrumb">';
	...
	afterAction: function(el){
			this.$owlItems.removeClass('owl-first').removeClass('owl-last'),
		    this.$owlItems.eq(this.currentItem).addClass('owl-first'),
            this.$owlItems.eq(this.currentItem + (this.options.items - 1)).addClass('owl-last')
