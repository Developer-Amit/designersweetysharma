	...
	public function index() {
		...
		foreach ($this->session->data['compare'] as $key => $product_id) {
			...
			if ($product_info) {
				...
				if ($product_info['rollover_image']) {
					$rollover_image = $this->model_tool_image->resize($product_info['rollover_image'], $this->config->get($this->config->get('config_theme') . '_image_compare_width'), $this->config->get($this->config->get('config_theme') . '_image_compare_height'));
				} else {
					$rollover_image = '';
				}
